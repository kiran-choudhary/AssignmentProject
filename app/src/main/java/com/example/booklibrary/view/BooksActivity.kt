...
class BooksActivity : AppCompatActivity(),ICallBack {
    ...
    override fun handleClick(book: AvailableBooksModel?) {
        ...
        intent.putExtra(getString(R.string.book_author),book?.bookAuthor)
        intent.putExtra(getString(R.string.book_desc),book?.bookDesc)
        intent.putExtra(getString(R.string.book_img_url),book?.bookImgUrl)
        intent.putExtra(getString(R.string.book_name),book?.bookName)
        intent.putExtra(getString(R.string.book_price),book?.bookPrice)
